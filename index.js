...
const config = require("./css/config.js");
...
const file = "./css/akses.json";
const userPath = path.join(__dirname, "./css/user.json");
let userApiBug = null;
let sock;
...
function saveUsers(users) {
  const filePath = path.join(__dirname, 'css', 'user.json');
  try {
